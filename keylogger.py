...
root.title("Typing Behaviour Tracker")
...
empty =Label(root,text="Typing Tracker",font='Verdana 11 bold').grid(row=3,column=2)
empty=Label(root,text=" ").grid(row=4,column=0)
Button(root,text="Start Typing Session", command=butaction).grid(row=5,column=2)
root.mainloop()
